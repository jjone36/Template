...
############################## Threshold
ret, thresh_1 = cv2.threshold(img, thresh = 127, maxval = 255, type = cv2.THRESH_BINARY)  # THRESH_BINARY_INV, THRESH_TRUNC
plt.imshow(thresh_1, cmap = 'gray')

thresh_adap_mean = cv2.adaptiveThreshold(img, maxValue = 255,
